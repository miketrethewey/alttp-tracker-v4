...
chests[55] = {
    name: "Fall to Escape Sewer (3) " + mini("glove") + " + " + mini("bomb") + '/' + mini("boots"),
    x: "26.8%",
    y: "32.4%",
    isOpened: false,
    isAvailable: function() {
...
chests[61] = {
    name: "Fat Fairy: Buy OJ bomb from Dark Link's House after " + mini("crystal0") + "5 " + mini("crystal0") + "6 (2 items)",
    x: "73.5%",
    y: "48.5%",
    isOpened: false,
    isAvailable: function() {
